...
(
	...
	, field(m_Bool)
	, field(m_Int, attr::Range(0, 100))
	, field(m_Float, attr::Range(0, 100))
	, field(m_Vector2f, attr::Range(0, 100))
	, field(m_Vector2i, attr::Range(0, 100))
	, field(m_Vector2u, attr::Range(0, 100))
	, field(m_Vector3f, attr::Range(0, 100))
	, field(m_Vector3i, attr::Range(0, 100))
	, field(m_YesReflect)
	, field(m_NoReflect)
